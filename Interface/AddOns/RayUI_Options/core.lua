...
R.Options.args.profiles = LibStub("AceDBOptions-3.0"):GetOptionsTable(R.data)
AceConfig:RegisterOptionsTable("RayUIProfiles", R.Options.args.profiles)
R.Options.args.profiles.order = -10
