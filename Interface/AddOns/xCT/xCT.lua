...
for i=1,numf do
	...
	if(i==1)then
		...
		f:SetPoint("BOTTOMRIGHT",UIParent, "BOTTOM", -310, 510)
		f:SetHeight(190)
		f:SetWidth(128)
	...
	elseif(i==2)then
		...
		f:SetPoint("BOTTOMRIGHT",UIParent, "BOTTOM", -200, 470)
		f:SetHeight(260)
		f:SetWidth(128)
		local a,_,c=f:GetFont()
		if (ct.damagefontsize=="auto")then
	...
	elseif(i==3)then
		...
		f:SetPoint("BOTTOMRIGHT",UIParent, "BOTTOM", 445, 470)
		f:SetHeight(260)
		f:SetWidth(128)
		local a,_,c=f:GetFont()
		if (ct.damagefontsize=="auto")then
...
SlashCmdList["XCT"]=function(input)
	...
	elseif(input=="mypos")then
		xCT1:ClearAllPoints()
		xCT1:SetPoint("BOTTOMRIGHT",UIParent, "BOTTOM", -310, 470)
		xCT1:SetHeight(190)
		xCT1:SetWidth(128)
		xCT2:ClearAllPoints()
		xCT2:SetPoint("BOTTOMRIGHT",UIParent, "BOTTOM", -200, 470)
		xCT2:SetHeight(260)
		xCT2:SetWidth(128)
		xCT3:ClearAllPoints()
		...
		xCT3:SetWidth(256)
		xCT4:ClearAllPoints()
		xCT4:SetPoint("BOTTOMRIGHT",UIParent, "BOTTOM", 445, 470)
		xCT4:SetHeight(260)
		xCT4:SetWidth(128)
	else
