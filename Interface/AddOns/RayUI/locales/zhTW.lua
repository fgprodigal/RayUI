...
do
    CALENDAR = "日曆"
    L["锚点已解锁，拖动锚点移动位置，右键单击微调，完成后点击锁定按钮。"] = "錨點已解鎖，拖動錨點移動位置，右鍵單擊微調，完成後點選鎖定按鈕。"
    L["网格数"] = "網格數"
    L["微调"] = "微調"
    L["锁定"] = "鎖定"
    ...
    L["Target Mover"] = "目標頭像"
    L["Focus Mover"] = "焦點頭像"
    L["TargetTarget Mover"] = "目標的目標頭像"
    L["Pet Mover"] = "寵物頭像"
    L["FocusTarget Mover"] = "焦點目標頭像"
    L["Arena Mover"] = "競技場頭像"
    L["Boss Mover"] = "首領頭像"
    L["Raid Mover"] = "團隊頭像"
    L["Raid40 Mover"] = "40人團隊頭像"
    L["RaidPets Mover"] = "團隊寵物頭像"
    L["RaidTank Mover"] = "團隊坦克頭像"
    L["玩家法术监视"] = "玩家法術監視"
    L["目标法术监视"] = "目標法術監視"
    L["焦点法术监视"] = "焦點法術監視"
    L["宠物法术监视"] = "寵物法術監視"
    ...
    L["你没有权限设置团队标记"] = "你沒有許可權設定團隊標記"
    L["点击右键选择信息条"] = "點擊右鍵選擇信息條"
    L["清除"] = "清除"
    L["自动隐藏信息条"] = "自動隱藏信息條"
    L["没有公会"] = "沒有公會"
    L["在线人数过多, 点击信息条查看"] = "在綫人數過多, 點擊信息條查看"
    L["免伤分析"] = "免傷分析"
    L["免伤"] = "免傷"
    L["未命中"] = "未命中"
    L["等级缓和"] = "等級緩和"
...
do
    ...
    L["你不能删除一个内建的法术，已停用此技能。"] = "你不能移除一個內建技能, 已停用此技能。"
    L["删除"] = "刪除"
    L["从当前分组删除"] = "從當前分組刪除"
end
do
...
do
    ...
    L["活动\"%s\"明天结束."] = "活動 \"%s\" 明天結束."
    L["活动\"%s\"今天开始."] = "活動 \"%s\" 今天開始."
    L["活动\"%s\"正在进行."] = "活動 \"%s\" 正在進行."
end
do
    L["灵魂"] = "靈魂"
    L["离线"] = "離綫"
