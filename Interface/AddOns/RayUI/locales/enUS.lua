...
L["头像"] = "UnitFrame"
  ...
  L["显示"] = "Display"
    ...
    L["启用头像覆盖血条"] = "Cover the HealthBar with 3D avatar"
  L["其他"] = "Others"
...
L["|cff7aa6d6Ray|r|cffff0000U|r|cff7aa6d6I|r的各种实用便利小功能."] = "|cff7aa6d6Ray|r|cffff0000U|r|cff7aa6d6I|r some useful stuff."
  ...
  L["自动释放尸体"] = "Auto release soul"
    L["战场中自动释放尸体"] = "Auto release soul in battlegrounds"
  L["商人"] = "Merchant"
    L["自动修理、自动卖灰色物品"] = "Auto repair, auto sell greys"
  L["补购毒药"] = true
    L["自动补购毒药，数量在misc/merchant.lua里修改"] = true
  L["任务"] = "Mission"
    L["任务等级，进/出副本自动收起/展开任务追踪，任务面板的展开/收起全部分类按钮"] = "Display mission level, in/out dungeon fold/unfold the tracker, the button to unfold/fold all the mission categories."
  L["自动交接任务"] = "Auto get/complate missions"
    L["自动交接任务，按shift点npc则不自动交接"] = "Disable auto get/complate missions when Shift down."
...
L["背包"] = "Bags"
  ...
  L["背包格大小"] = "Size of cell in bags"
  L["银行格大小"] = "Size of cell in bank"
