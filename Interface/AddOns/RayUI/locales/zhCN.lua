...
do
    ...
    L["Target Mover"] = "目标头像"
    L["Focus Mover"] = "焦点头像"
    L["TargetTarget Mover"] = "目标的目标头像"
    L["Pet Mover"] = "宠物头像"
    L["FocusTarget Mover"] = "焦点目标头像"
    L["Arena Mover"] = "竞技场头像"
    L["Boss Mover"] = "首领头像"
    L["Raid Mover"] = "团队头像"
...
do
    L["战斗文字"] = true
    L["RayUI_CombatText_OutGoing"] = "战斗文字(输出)"
    L["RayUI_CombatText_InComing"] = "战斗文字(承受伤害)"
    L["RayUI_CombatText_Healing"] = "战斗文字(承受治疗)"
    L["RayUI_CombatText_Message"] = "战斗文字(信息)"
    L["RayUI_CombatText_Power"] = "战斗文字(获得能量)"
end
