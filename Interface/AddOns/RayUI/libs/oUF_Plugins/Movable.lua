...
do
	...
	getBackdrop = function(obj, isHeader)
		...
		S:Reskin(backdrop)
		S:CreateBD(backdrop)
		backdrop.SetBackdropColor = R.dummy
		backdrop.SetBackdropBorderColor = R.dummy
		...
		backdrop:HookScript("OnEnter", function(self)
			self.name:SetTextColor(self.glow:GetBackdropBorderColor())
		end)
...
do
	...
	function frame:VARIABLES_LOADED()
		...
		SLASH_MOVEOUF1 = "/omf"
		SlashCmdList["MOVEOUF"] = R.MoveoUF
