...
LM_PROFESSION_MOUNT_SPELLS = {
    [LM_SPELL_FLYING_MACHINE] = 202,
    [LM_SPELL_TURBO_CHARGED_FLYING_MACHINE] = 202,
    [LM_SPELL_MAGNIFICENT_FLYING_CARPET] = 197,
    [LM_SPELL_FROSTY_FLYING_CARPET] = 197,
    [LM_SPELL_FLYING_CARPET] = 197,
}
