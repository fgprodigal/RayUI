...
L["Hint: Left-Click to set active mode."] = "Hinweis: Links-Klick um aktiven Modus einzustellen."
...
L["Right-click to set active set."] = "Rechts-Klick um aktive Reihe einzustellen."
