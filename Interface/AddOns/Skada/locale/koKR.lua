...
L["Absorbed"] = "2.3 흡수" -- Needs review
L["Absorbs"] = "흡수"
L["Absorbs and healing"] = "흡수량과 치유량"
L["Absorb spells"] = "흡수 세부" -- Needs review
...
L["Aggressive combat detection"] = "적극적인 전투 감지" -- Needs review
...
L["Ask"] = "질문"
L["Attack"] = "공격"
L["Automatically switch to set 'Current' and this mode after a wipe."] = "보스와의 전투시 전멸후 자동으로 이 모드와 함께 '현재' 세분화로 설정합니다." -- Needs review
...
L["Buff spell list"] = "버프 목록" -- Needs review
L["Buff uptimes"] = "버프 지속시간" -- Needs review
...
L["Choose the background color of the bars."] = "바의 배경 색상을 선택합니다." -- Needs review
...
L["Class icons"] = "직업 아이콘" -- Needs review
L["Click for"] = "클릭 ->"
L["Clickthrough"] = "클릭무시" -- Needs review
L["Columns"] = "세로(칸)"
L["Combat mode"] = "전투 모드"
L["Combined"] = "결함"
L["Condensed"] = "요약"
...
L["Damage taken"] = "3. 받은 피해" -- Needs review
L["Damage taken by spell"] = "3.1 받은 피해량 (주문별)" -- Needs review
...
L["Detailed"] = "상세"
L["Disable"] = "비활성화"
L["Disables mouse clicks on bars."] = "바를 클릭할 수 없도록 합니다." -- Needs review
...
L["DPS"] = "1.1 DPS" -- Needs review
L["DTPS"] = "DTPS" -- Needs review
L["Enable"] = "활성화"
L["Enables the title bar."] = "제목 표시줄을 활성화 합니다."
L["Enemy damage done"] = "3.2. 받은 피해량 (대상별)" -- Needs review
L["Enemy damage taken"] = "1.2. 데미지 (대상별)" -- Needs review
...
L["Hide window"] = "창 숨김" -- Needs review
...
L["Lines"] = "줄"
L["List of damaged players"] = "플레이어별 받은 목록" -- Needs review
...
L["Max bars"] = "최대 바"
L["Maximum hit:"] = "최대 타격:"
L["Merge pets"] = "소환수 합산" -- Needs review
L["Merges pets with their owners. Changing this only affects new data."] = "주인에게 소환수의 데이터를 합산합니다. 새로운 데이터 기록시에 적용됩니다." -- Needs review
L["Minimum hit:"] = "최소 타격:"
L["Missed"] = "빗나감"
L["Mode"] = "모드"
...
L["Outlined monochrome"] = "단색 외곽선" -- Needs review
L["Overheal"] = "초과치유"
L["Overhealing"] = "2.1 초과치유" -- Needs review
L["Parry"] = "무기막기"
L["Party"] = "파티"
L["Percent"] = "퍼센트"
L["Play sound"] = "소리 재생"
...
L["Sets the font flags."] = "글꼴 속성을 설정합니다." -- Needs review
L["Sets the scale of the window."] = "창의 크기를 설정합니다." -- Needs review
L["'s Fails"] = "의 실수"
...
L["Shows a extra row with a summary in certain modes."] = "지원되는 모드에서 총량을 나타내는 추가 열을 표시합니다." -- Needs review
L["Shows numbers for relative ranks for modes where it is applicable."] = "사용 가능한 모드에서 순위를 표시합니다." -- Needs review
L["Show spark effect"] = "바 끝 강조효과 사용" -- Needs review
...
L["Show totals"] = "총량 표시" -- Needs review
...
L["The height of the title frame."] = "제목 바 높이" -- Needs review
...
L["There is nothing to report."] = "보고할 자료가 없습니다." -- Needs review
...
L["Title bar"] = "제목 바"
L["Title height"] = "제목 바 높이" -- Needs review
...
L["Top right"] = "상단-우측"
L["Total"] = "전체"
L["Total healing"] = "2.2 총 치유량" -- Needs review
L["TPS"] = "TPS"
L["Use class icons where applicable."] = "해당 직업 아이콘 사용" -- Needs review
...
L["Windows"] = "창"
L["Wipe mode"] = "전멸후 모드 전환" -- Needs review
L["Yes"] = "예"
