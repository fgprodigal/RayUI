...
L["Absorb"] = "흡수"
L["Absorb details"] = "흡수 세부" -- Needs review
L["Absorbed"] = "흡수"
L["Absorbs"] = "흡수"
...
L["Automatically switch to set 'Current' and this mode when entering combat."] = "전투 시작시 '현재' 전투의 설정한 모드에 따라 자동적으로 전환합니다." -- Needs review
-- L["Autostop"] = ""
...
L["Controls if data is reset when you enter an instance."] = "인던에 진입할 경우에 자료를 초기화하도록 설정합니다." -- Needs review
L["Controls if data is reset when you join a group."] = "파티/공격대에 참여할 경우에 자료를 초기화하도록 설정합니다." -- Needs review
L["Controls if data is reset when you leave a group."] = "파티/공격대에서 떠날 경우에 자료를 초기화하도록 설정합니다." -- Needs review
...
L["Data segments to keep"] = "보존할 자료 구분" -- Needs review
L["Death log"] = "죽음 로그"
L["Deaths"] = "죽음"
L["Deaths:"] = "죽음:"
L["Debuffs"] = "디버프"
...
L["Do not warn while tanking"] = "탱킹 중일 땐 경고하지 않음" -- Needs review
L["Do you want to reset Skada?"] = "Skada를 초기화하시겠습니까?" -- Needs review
L["DPS"] = "DPS"
L["DTPS"] = "DTPS"
L["Enable"] = "활성화"
L["ENABLED"] = "활성화됨"
L["Enables the title bar."] = "제목 표시줄을 활성화합니다." -- Needs review
L["Enemies"] = "적"
...
L["Health"] = "생맹력" -- Needs review
L["Hide in combat"] = "전투 중 숨김" -- Needs review
L["Hide in PvP"] = "PvP 시 숨기기" -- Needs review
...
L["Hides Skada's window when in combat."] = "전투 시 Skada창을 숨깁니다." -- Needs review
L["Hides Skada's window when not in a party or raid."] = "파티 또는 공격대가 아닐 때 Skada 창을 숨깁니다." -- Needs review
L["Hide when solo"] = "솔로잉 시 숨김" -- Needs review
L["Hide window"] = "창 숨김"
L["Hint: Left-Click to toggle Skada window."] = "힌트: 좌-클릭으로 Skada 창을 표시하거나 숨깁니다." -- Needs review
L["Hit"] = "일반"
L["HPS"] = "HPS"
L["HPS:"] = "HPS:"
...
L["Maximum hit:"] = "최대 타격:"
L["Merge pets"] = "소환수 합산"
L["Merges pets with their owners. Changing this only affects new data."] = "주인에게 소환수의 데이터를 합산합니다. 새로운 데이터 기록 시에 적용됩니다." -- Needs review
L["Minimum hit:"] = "최소 타격:"
L["Missed"] = "빗나감"
L["Mode"] = "모드"
-- L["Mode description"] = ""
...
L["Reset"] = "초기화"
-- L["Reset description"] = ""
L["Reset on entering instance"] = "인던 진입 시 초기화" -- Needs review
L["Reset on joining a group"] = "파티/공격대 참여 시 초기화" -- Needs review
L["Reset on leaving a group"] = "파티/공격대 탈퇴 시 초기화" -- Needs review
L["resets all data"] = "모든 자료 초기화"
L["Resist"] = "저항"
L["Resisted"] = "저항"
L["Return after combat"] = "전투 후 돌아가기"
L["Return to the previous set and mode after combat ends."] = "전투 종료 후에 이전 설정 및 모드로 돌아갑니다." -- Needs review
...
L["Shows threat on focus target, or focus target's target, when available."] = "주시 대상 또는 주시 대상의 대상을 사용할 때 위협을 표시합니다." -- Needs review
...
L["Skada will not collect any data when automatically hidden."] = "Skada에서 자료를 수집하지 않을 때 자동으로 숨깁니다." -- Needs review
L["Snaps the window size to best fit when resizing."] = "창 크기를 조절할 때 최적의 크기로 조절되게 합니다." -- Needs review
...
L["The number of fight segments to keep. Persistent segments are not included in this."] = "보존할 전투 자료의 수입니다. 지속 자료는 여기 포함되지 않습니다." -- Needs review
...
L["The sound that will be played when your threat percentage reaches a certain point."] = "당신의 위협 수준이 특정 지점에 도달했을 때 소리를 재생합니다." -- Needs review
