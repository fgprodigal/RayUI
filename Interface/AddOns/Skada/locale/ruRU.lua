...
L["Bar display is the normal bar window used by most damage meters. It can be extensively styled."] = "Полоса дисплея это обычная оконная полоса, используемая для большинства, измерения урона. Оно может быть широко стилизовано."
...
L["Buttons"] = "Кнопки"
L["CC"] = "СК"
L["CC breakers"] = "СК прерывание"
L["CC breaks"] = "СК разрывы"
L["Change"] = "Изменение"
L["Channel"] = "Канал"
...
L["Power"] = "Энергия"
L["Power gains"] = "nолученные ресурсы"
L["Profiles"] = "Профили"
...
L["The mode list will be sorted to reflect usage instead of alphabetically."] = "Список режимов будет отсортирован для отражения по использованию вместо алфавитного."
