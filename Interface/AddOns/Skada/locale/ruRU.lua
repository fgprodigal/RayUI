...
L["%s dies"] = "%s умирает"
L["%s on %s removed by %s"] = "%s на %s удалены %s"
...
L["Append a count to set names with duplicate mob names."] = "Добавить счетчик, чтобы установить имена с совпадающими именами мобов."
L["Apply"] = "Применить"
...
L["Energy gain sources"] = "Источники получаемой энергии"
L["Energy gained"] = "Energy gained"
...
L["Focus gain sources"] = "Источники получаемой концентрации"
L["Focus gained"] = "Focus gained"
...
L["Hint: Left-Click to set active mode."] = "Подсказка: [Левый клик], чтобы установить активный режим."
L["Hint: Left-Click to toggle Skada window."] = "Подсказка: [Левый клик] открывает/закрывает окно Skada."
L["Hit"] = "Попадание"
L["Holy power gain sources"] = "Источники получаемой энергии света"
L["Holy power gained"] = "Holy power gained"
L["How often windows are updated. Shorter for faster updates. Increases CPU usage."] = "Как часто обновляется окно. Для более коротких, быстрых обновлений. Увеличивает нагрузку процессора."
L["HPS"] = "ИВС"
L["HPS:"] = "ИВС:"
L["If checked, bar width is fixed. Otherwise, bar width depends on the text width."] = "При проверки, ширины полоса будет исправлена. В противном случае ширина, полосы зависит от ширины текста."
...
L["Inline bar display"] = "Однострочный дисплей полос"
L["Inline display is a horizontal window style."] = "Однострочный дисплей горизонтального стиля окна."
L["Instance"] = "Подземелье"
L["Interrupts"] = "Прерывание"
L["Keep segment"] = "Хранить сегмент"
L["Keeps the player shown last even if there is not enough space."] = "Сохраняет последнего игрока, даже если места недостаточно."
...
L["Maximum"] = "Максимально"
L["Maximum hit:"] = "Максимальное попадание:"
L["Memory usage is high. You may want to reset Skada, and enable one of the automatic reset options."] = "Высокое использование памяти. Возможно, вы хотите сбросить Skada, и включить один из вариантов автоматического сброса."
...
L["Profiles"] = "Профили"
L["Rage gain sources"] = "Источники получаемой ярости"
L["Rage gained"] = "Rage gained"
L["Raid"] = "Рейд"
L["RDPS"] = "РУВС"
L["RealID"] = "RealID"
L["Reflect"] = "Отражение"
...
L["Runic power gain sources"] = "Источники получаемой силы рун"
L["Runic power gained"] = "Runic power gained"
L["'s "] = " - "
...
L["Shows raw threat percentage relative to tank instead of modified for range."] = "Показывает процент угрозы по сравнению с танком, а не по расстоянию."
...
L["Spell school colors"] = "Школа заклинание цветов"
...
L["The color used for the border."] = "Цвет, используемый для границы."
...
L["The size of the texture pattern."] = "Размер текстуры для шаблона."
...
L["This determines what other frames will be in front of the frame."] = "Это определяет то, что другие рамки будут находиться в передней части рамке."
...
L["Tile the background texture."] = "Заголовок фона текстур"
L["Title bar"] = "Полоса заглавия"
L["Title color"] = "Заголовок цвета"
...
L["Use spell school colors where applicable."] = "Использовать школу заклинаний цветов там, где это применимо."
L["Various tweaks to get around deficiences and problems in the game's combat logs. Carries a small performance penalty."] = "Различные хитрости, чтобы обойти недостатки и проблемы в боевых логах игры. Несет в себе небольшую задержку."
