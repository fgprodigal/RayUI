...
L["All Skada functionality is now in 1 addon folder."] = "Toutes les fonctionnalités de Skada sont désormais dans un seul répertoire d'add-ons." -- Needs review
L["Alternate color"] = "Couleur alternative"
L["Announce CC breaking to party"] = "Annoncer les casseurs de contrôle au groupe"
L["Appearance"] = "Apparence"
L["Append a count to set names with duplicate mob names."] = "Ajoute un compteur aux noms d'ensemble ayant des noms de monstres dupliqués." -- Needs review
L["Ask"] = "Demander"
L["Attack"] = "Attaque"
...
L["Click below and configure your '|cFFFF0000Disabled Modules|r'."] = "Cliquez ci-dessous et configurer vos '|cFFFF0000modules désactivés|r'." -- Needs review
...
L["Controls the way set names are displayed."] = "Contrôle la façon dont les noms d'ensemble sont affichés." -- Needs review
...
L["Disabled Modules"] = "Modules désactivés" -- Needs review
...
L["Enemy healing done"] = "Soins prodigués (ennemis)" -- Needs review
L["Enemy healing taken"] = "Soins reçus (ennemis)" -- Needs review
...
L["Immune"] = "Insensible"
L["Include set"] = "Inclure l'ensemble" -- Needs review
L["Include set name in title bar"] = "Inclure le nom d'ensemble dans la barre de titre" -- Needs review
L["Informative tooltips"] = "Bulles d'aide informatives"
L["Instance"] = "Instance" -- Needs review
...
L["Power"] = "Puissance" -- Needs review
L["Profiles"] = "Profils"
L["Raid"] = "Raid"
L["RDPS"] = "RDPS"
...
L["Set format"] = "Format des ensembles" -- Needs review
...
L["Skada has changed!"] = "Du changement pour Skada !" -- Needs review
...
L["Skada will |cFFFF0000NOT|r function properly until you delete the following AddOns:"] = "Skada ne fonctionnera |cFFFF0000PAS|r correctement tant que vous n'avez pas supprimé les add-ons suivants :" -- Needs review
...
L["This change requires a UI reload. Are you sure?"] = "Ce changement nécessite un rechargement de l'IU. Êtes-vous sûr ?" -- Needs review
...
L["Tick the modules you want to disable."] = "Cocher les modules que vous souhaitez désactiver." -- Needs review
...
L["TotalHealing"] = "Total des soins" -- Needs review
L["TPS"] = "MPS"
